...
function toggleSubscribe(toUserId, obj) {
	...
	if ($(obj).text() === "구독취소") {
		console.log("toggleSubscribe  구독취소");
		$.ajax({
			type:"delete",
		...
		console.log("toggleSubscribe  구독하기");
		$.ajax({
			type:"post",
			url:`/api/subscribe/${toUserId}`,
			dataType:"json"
...
function profileImageUpload( pageUserId, principalId) {
	...
	// console.log("profileImageUpload pageUserId  ", pageUserId);
	// console.log("profileImageUpload principallId  ", principallId);
	...
	$("#userProfileImageInput").click(); //창활성화
	...
	$("#userProfileImageInput").on("change", (e) => {
		...
		$.ajax({
			...
			//console.log("사진 전송 성공시 이미지 변경 ", res.data);
